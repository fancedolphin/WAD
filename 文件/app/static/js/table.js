            ...
            case "/choose_course":
                ...
                <td>
                    <button type="button" class="btn ${item.course_capacity != 0 ? 'btn-success' : 'btn-secondary'} choose-class-btn" data-course-capacity="${item.course_capacity}"
                      data-classid="${item.course_no}" onclick="handleChoosed(${item.course_capacity}, ${item.course_no})">Select Course</button>
                </td>
            </tr>`)
                break;
            case "/isChoosed_course":
                ...
                <td>
                    <button type="button" class="btn btn-success choose-class-btn" data-course-capacity="${item.course_capacity}"
                      data-classid="${item.course_no}" onclick="handleChoosed(${item.course_capacity}, ${item.course_no})">Cancel</button>
                </td>
            </tr>`)
                break;
            case "/score_query":
