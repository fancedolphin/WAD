...
create database if not exists grade_manage_system;//
use grade_manage_system;


create table if not exists major(major_id char(3) primary key, major_name varchar(20) not null unique);//


create table if not exists student(student_id char(10) primary key, student_name varchar(20) not null, sex char(2), 
...
create table if not exists teacher(teacher_id char(5) primary key, teacher_name varchar(20) not null, sex char(2), 
                     birth_year char(4), password varchar(128) not null);//


create table if not exists course(course_id char(5) primary key, course_name varchar(20) not null, 
...
create table if not exists major_course(major_id char(3), course_id char(5));//
...
create table if not exists student_course(student_id char(10), course_id char(5), grade tinyint unsigned);//
